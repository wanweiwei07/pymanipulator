...
from motionplanning.rtreekd import rtreekd as rt
...
class DDRRTConnect(object):
    ...
    def __init__(self, start, goal, iscollidedfunc, jointlimits, expanddis=.5,
        ...
        self.__rtstart = rt.RtreeKD(self.__start.size, 'start')
        self.__rtend = rt.RtreeKD(self.__end.size, 'end')

        self.__nodeliststart = [Node(self.__start)]
        self.__nodelistend = [Node(self.__end)]
        self.__obstaclelist = []
        self.__rtstart.insert(self.__start.tolist())
        self.__rtend.insert(self.__end.tolist())
    ...
    def planning(self, obstaclelist=[], animation=False):
        ...
        while True:
            ...
            while True:
                ...
                nind = self.getNearestRTIndex(self.__rtstart, randpoint)
            ...
            if self.__iscollidedcallback(newnode.point, obstaclelist,
                ...
                while True:
                    ...
                    while True:
                        ...
                        nind = self.getNearestRTIndex(self.__rtend, randpoint)
                    ...
                    self.__rtend.insert(newnode.point)
            ...
            self.__rtstart.insert(newnode.point)
    ...
    def getNearestRTIndex(self, rt, randpoint):
        return rt.nearest(randpoint.tolist())[0]
